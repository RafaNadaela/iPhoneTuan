...
-(void)createImageData{
    for(int i = 0;i < 3 ;i++){
        ...
        if(2 == i){
            ...
            //205,1002,236,70
            self.enterBtn = [[UIButton alloc]initWithFrame:CGRectMake(103,420, 118, 35)];
//            self.enterBtn.backgroundColor = [UIColor redColor];
            [self.enterBtn setTitle:@"sjsjsjjsjjss" forState:UIControlStateNormal];
